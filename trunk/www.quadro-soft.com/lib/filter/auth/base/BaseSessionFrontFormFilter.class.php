...
/**
 * SessionFront filter form base class.
 *
 * @package    quadrosoft
 * @subpackage filter
 ...
 */
class BaseSessionFrontFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('session_front_filters[%s]');
