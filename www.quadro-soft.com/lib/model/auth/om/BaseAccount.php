...
abstract class BaseAccount extends BaseObject  implements Persistent {
  ...
  const PEER = 'AccountPeer';
	...
	/**
	 * The value for the coo_remember field.
	 * @var        string
	 */
	protected $coo_remember;
	...
	/**
	 * @var        array Account2Credential[] Collection to store aggregation of Account2Credential objects.
	 */
	protected $collAccount2Credentials;

	/**
	 * @var        Criteria The criteria used to select the current contents of collAccount2Credentials.
	 */
	private $lastAccount2CredentialCriteria = null;
	...
	/**
	 * Get the [coo_remember] column value.
	 * 
	 * @return     string
	 */
	public function getCooRemember()
	{
		return $this->coo_remember;
	}
	...
	public function setCid($v)
	{
		...
		if ($this->cid !== $v) {
			$this->cid = $v;
			$this->modifiedColumns[] = AccountPeer::CID;
		}
	...
	/**
	 * Set the value of [coo_remember] column.
	 * 
	 * @param      string $v new value
	 * @return     Account The current object (for fluent API support)
	 */
	public function setCooRemember($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->coo_remember !== $v) {
			$this->coo_remember = $v;
			$this->modifiedColumns[] = AccountPeer::COO_REMEMBER;
		}
	...
	public function setModifiedAt($v)
	{
		...
		if ( $this->modified_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = AccountPeer::MODIFIED_AT;
			}
		} // if either are not null
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(AccountPeer::IS_ACTIVE,AccountPeer::IS_DELETED))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			$this->coo_remember = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->is_active = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->is_deleted = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collAccount2Credentials = null;
			$this->lastAccount2CredentialCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collAccount2Credentials !== null) {
				foreach ($this->collAccount2Credentials as $referrerFK) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setCooRemember($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AccountPeer::CID)) $criteria->add(AccountPeer::CID, $this->cid);
		...
		if ($this->isColumnModified(AccountPeer::COO_REMEMBER)) $criteria->add(AccountPeer::COO_REMEMBER, $this->coo_remember);
		...
		if ($this->isColumnModified(AccountPeer::MODIFIED_AT)) $criteria->add(AccountPeer::MODIFIED_AT, $this->modified_at);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCooRemember($this->coo_remember);
		...
		if ($deepCopy) {
			...
			foreach ($this->getAccount2Credentials() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addAccount2Credential($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collAccount2Credentials collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addAccount2Credentials()
	 */
	public function clearAccount2Credentials()
	{
		$this->collAccount2Credentials = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collAccount2Credentials collection (array).
	 *
	 * By default this just sets the collAccount2Credentials collection to an empty array (like clearcollAccount2Credentials());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initAccount2Credentials()
	{
		$this->collAccount2Credentials = array();
	}

	/**
	 * Gets an array of Account2Credential objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Account has previously been saved, it will retrieve
	 * related Account2Credentials from storage. If this Account is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array Account2Credential[]
	 * @throws     PropelException
	 */
	public function getAccount2Credentials($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		}
		...
		if ($this->collAccount2Credentials === null) {
			if ($this->isNew()) {
			   $this->collAccount2Credentials = array();
				...
				$criteria->add(Account2CredentialPeer::ACCOUNT_ID, $this->id);

				Account2CredentialPeer::addSelectColumns($criteria);
				$this->collAccount2Credentials = Account2CredentialPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				Account2CredentialPeer::addSelectColumns($criteria);
				if (!isset($this->lastAccount2CredentialCriteria) || !$this->lastAccount2CredentialCriteria->equals($criteria)) {
					$this->collAccount2Credentials = Account2CredentialPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastAccount2CredentialCriteria = $criteria;
		return $this->collAccount2Credentials;
	}

	/**
	 * Returns the number of related Account2Credential objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Account2Credential objects.
	 * @throws     PropelException
	 */
	public function countAccount2Credentials(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collAccount2Credentials === null) {
			if ($this->isNew()) {
				...
				$count = Account2CredentialPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastAccount2CredentialCriteria) || !$this->lastAccount2CredentialCriteria->equals($criteria)) {
					...
					$count = count($this->collAccount2Credentials);
				}
			} else {
				$count = count($this->collAccount2Credentials);
			}
	...
	/**
	 * Method called to associate a Account2Credential object to this object
	 * through the Account2Credential foreign key attribute.
	 *
	 * @param      Account2Credential $l Account2Credential
	 * @return     void
	 * @throws     PropelException
	 */
	public function addAccount2Credential(Account2Credential $l)
	{
		if ($this->collAccount2Credentials === null) {
			$this->initAccount2Credentials();
		}
		if (!in_array($l, $this->collAccount2Credentials, true)) { // only add it if the **same** object is not already associated
			array_push($this->collAccount2Credentials, $l);
			$l->setAccount($this);
		}
	}
	 ...
	 * been saved, it will retrieve related Account2Credentials from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Account.
	 */
	public function getAccount2CredentialsJoinCredential($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(AccountPeer::DATABASE_NAME);
		}
		...
		if ($this->collAccount2Credentials === null) {
			if ($this->isNew()) {
				...
				$this->collAccount2Credentials = Account2CredentialPeer::doSelectJoinCredential($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
		if ($deep) {
			if ($this->collAccount2Credentials) {
				foreach ((array) $this->collAccount2Credentials as $o) {
